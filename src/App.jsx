...
const tab_guides = {
  ppt: {
    title: 'PPT 생성(표준산출물)',
    desc: '표준 파워포인트(.pptx) 산출물 일괄편집, 엑셀 데이터 매핑 생성, 스마트 애니메이션, PPT ➜ HWPX 양식 융합, HWP ➔ HWPX 변환 및 MD(마크다운) ➔ MS Word(.docx) 일괄 변환을 통합 제공합니다.',
    steps: [
      '상단 서브 탭에서 원하는 산출물 변환/생성 도구 선택 (PPT 일괄편집, 엑셀 매핑, HWPX 변환, MD ➔ Word 변환 등)',
      '대상 파일(.pptx, .xlsx, .hwp, .md 등) 업로드 또는 직접 입력/드래그 앤 드롭',
      '원터치 일괄 자동 변환/생성 수행 및 원하는 폴더 선택/ZIP 저장'
    ],
    tips: 'MD ➔ Word 변환은 마크다운의 표(Table), 목록, 인용구, 코드 블록을 표준 MS Word 서식으로 즉시 변환하며 테마/폰트 커스터마이징을 지원합니다.'
  },
  g2b: {
    title: '나라장터 정보조회',
        ...
        <header className="content-header">
          ...
          <div className="header-right">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '2px', marginRight: '8px' }}>
              ...
              <span style={{ fontSize: '12px', color: 'var(--accent-blue)', fontWeight: 700, fontFamily: 'monospace' }}>2026.09.06 v2.11.2</span>
            </div>
